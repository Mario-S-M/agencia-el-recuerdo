...
const DESTINOS_SEED: Array<{
...
}> = [
  {
    nombre: 'Cancún',
    pais: 'México',
    descripcion: 'Paraíso caribeño con playas de arena blanca y mar turquesa.',
    destacado: true,
    activo: true,
  },
  {
    nombre: 'Riviera Maya',
    pais: 'México',
    descripcion: 'Costera repleta de resorts, cenotes y ruinas mayas.',
    destacado: true,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion:
      'Destino de playa en la costa del Pacífico con bahía en forma de media luna.',
    destacado: true,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion: 'Ciudad costera con playas doradas, malecón y vida nocturna.',
    destacado: true,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion:
      'Extremo sur de Baja California con el icónico Arco y avistamiento de ballenas.',
    destacado: true,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion:
      'Puerto con playas extensas, centro histórico y el famoso Carnaval.',
    destacado: false,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion:
      'Bahías vírgenes en Oaxaca con ecoturismo y playas tranquilas.',
    destacado: false,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion:
      'Isla con los mejores arrecifes del Caribe para buceo y snorkel.',
    destacado: true,
    activo: true,
  },
  {
    ...
    pais: 'México',
    descripcion:
      'Clásico destino de playa con la Quebrada y bahía espectacular.',
    destacado: false,
    activo: true,
  },
  {
    nombre: 'Manzanillo',
    pais: 'México',
    descripcion: 'Puerto de gran actividad pesquera y playas de arena dorada.',
    destacado: false,
    activo: true,
  },
];
...
const PAQUETES_SEED: Array<{
...
}> = [
  {
    ...
    descripcion:
      'Disfruta de 3 noches en Cancún con vuelo redondo y todo incluido.',
    destacado: true,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'Paquete romántico con acceso ilimitado a parques Xcaret y Xel-Há.',
    destacado: true,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
      'Hospedaje 5 noches',
      'Acceso a parques Xcaret',
      'Cena romántica',
      'Tour en catamarán',
    ],
  },
  {
    ...
    descripcion:
      'Relájate en Ixtapa con vuelo, traslados y hospedaje todo incluido.',
    destacado: true,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'Explora Puerto Vallarta con media pensión y tour de snorkel incluido.',
    destacado: false,
    todoIncluido: false,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'Vive el lujo en Los Cabos con tour en barco al Arco y avistamiento de ballenas.',
    destacado: true,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
      ...
      'Tour al Arco de Cabo San Lucas',
  ...
  },
  {
    ...
    descripcion:
      'Paquete familiar perfecto para disfrutar Mazatlán con los niños.',
    destacado: false,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'Conecta con la naturaleza en las bahías vírgenes de Huatulco.',
    destacado: false,
    todoIncluido: false,
    incluye: [
      'Vuelo redondo',
      'Traslado aeropuerto',
      'Hospedaje 3 noches con desayuno',
      'Tour de bahías en barco',
    ],
  },
  {
    ...
    descripcion:
      'Sumérgete en los mejores arrecifes del Caribe con equipo de buceo incluido.',
    destacado: true,
    todoIncluido: false,
    incluye: [
      'Vuelo redondo',
      'Ferry Cancún-Cozumel',
      'Hospedaje 4 noches con media pensión',
      '2 inmersiones de buceo',
      'Equipo completo',
    ],
  },
  {
    ...
    descripcion:
      'Revive la magia de Acapulco con vista a la bahía y espectáculo de la Quebrada.',
    destacado: false,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'El mejor destino de pesca deportiva con tour de pesca incluido.',
    destacado: false,
    todoIncluido: false,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'Una semana completa en la Riviera Maya con recorrido por Tulum y Cobá.',
    destacado: true,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    incluye: [
      'Vuelo redondo',
      'Traslado aeropuerto',
      'Hospedaje 4 noches con desayuno',
      '2 rondas de golf en campo Vista Vallarta',
    ],
  },
  {
    ...
    descripcion:
      'Combina hospedaje en Ixtapa con un crucero por la costa del Pacífico.',
    destacado: true,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
  ...
  },
  {
    ...
    descripcion:
      'Experiencia gastronómica con cenas en restaurantes exclusivos de Cancún.',
    destacado: false,
    todoIncluido: true,
    incluye: [
      'Vuelo redondo',
...
const FECHAS_SALIDA_SEED: Array<{
  ...
  // ── Mayo 2026 ──
  {
    paqueteNombre: 'Escapada Cancún 3 Noches',
    fechaSalida: '2026-05-02',
    fechaRegreso: '2026-05-05',
    cupoMaximo: 30,
    cupoMinimo: 5,
    cupoDisponible: 15,
  },
  {
    paqueteNombre: 'Ixtapa 4 Noches Todo Incluido',
    fechaSalida: '2026-05-05',
    fechaRegreso: '2026-05-09',
    cupoMaximo: 25,
    cupoMinimo: 4,
    cupoDisponible: 8,
  },
  {
    paqueteNombre: 'Aventura en Puerto Vallarta 3 Noches',
  ...
  {
    paqueteNombre: 'Los Cabos 5 Noches Premium',
  ...
  {
    paqueteNombre: 'Mazatlán Familiar 4 Noches',
    fechaSalida: '2026-05-15',
    fechaRegreso: '2026-05-19',
    cupoMaximo: 30,
    cupoMinimo: 5,
    cupoDisponible: 20,
  },
  {
    paqueteNombre: 'Cancún Gastro 4 Noches',
    fechaSalida: '2026-05-15',
    fechaRegreso: '2026-05-19',
    cupoMaximo: 20,
    cupoMinimo: 4,
  ...
  {
    paqueteNombre: 'Huatulco Ecológico 3 Noches',
    fechaSalida: '2026-05-18',
    fechaRegreso: '2026-05-21',
    cupoMaximo: 15,
    cupoMinimo: 3,
    cupoDisponible: 5,
  },
  {
    paqueteNombre: 'Cozumel Buceo 4 Noches',
    fechaSalida: '2026-05-20',
    fechaRegreso: '2026-05-24',
    cupoMaximo: 12,
    cupoMinimo: 3,
    cupoDisponible: 0,
  },
  {
    paqueteNombre: 'Riviera Maya 7 Noches Todo Incluido',
    fechaSalida: '2026-05-22',
    fechaRegreso: '2026-05-29',
    cupoMaximo: 25,
    cupoMinimo: 5,
    cupoDisponible: 12,
  },
  {
    paqueteNombre: 'Ixtapa 6 Noches con Crucero',
    fechaSalida: '2026-05-25',
    fechaRegreso: '2026-05-31',
    cupoMaximo: 30,
    cupoMinimo: 6,
    cupoDisponible: 18,
  },
  {
    paqueteNombre: 'Acapulco Clásico 2 Noches',
    fechaSalida: '2026-05-28',
    fechaRegreso: '2026-05-30',
    cupoMaximo: 20,
    cupoMinimo: 3,
    cupoDisponible: 4,
  },
  {
    paqueteNombre: 'Manzanillo Pesca Deportiva 3 Noches',
    fechaSalida: '2026-05-30',
    fechaRegreso: '2026-06-02',
    cupoMaximo: 15,
    cupoMinimo: 3,
    cupoDisponible: 6,
  },
  ...
  {
    paqueteNombre: 'Luna de Miel Riviera Maya 5 Noches',
    fechaSalida: '2026-06-05',
    fechaRegreso: '2026-06-10',
    cupoMaximo: 20,
    cupoMinimo: 4,
    cupoDisponible: 10,
  },
  {
    paqueteNombre: 'Cozumel Buceo 4 Noches',
    fechaSalida: '2026-06-05',
    fechaRegreso: '2026-06-09',
    cupoMaximo: 12,
    cupoMinimo: 3,
    cupoDisponible: 8,
  },
  {
    paqueteNombre: 'Puerto Vallarta Golf 4 Noches',
    fechaSalida: '2026-06-08',
    fechaRegreso: '2026-06-12',
    cupoMaximo: 18,
    cupoMinimo: 3,
    cupoDisponible: 7,
  },
  ...
  {
    paqueteNombre: 'Ixtapa 4 Noches Todo Incluido',
    fechaSalida: '2026-06-19',
    fechaRegreso: '2026-06-23',
    cupoMaximo: 25,
    cupoMinimo: 4,
    cupoDisponible: 20,
  },
  ...
  {
    paqueteNombre: 'Aventura en Puerto Vallarta 3 Noches',
    fechaSalida: '2026-06-26',
    fechaRegreso: '2026-06-29',
    cupoMaximo: 20,
    cupoMinimo: 3,
    cupoDisponible: 12,
  },
  {
    paqueteNombre: 'Huatulco Ecológico 3 Noches',
    fechaSalida: '2026-06-29',
    fechaRegreso: '2026-07-02',
    cupoMaximo: 15,
    cupoMinimo: 3,
    cupoDisponible: 2,
  },
  ...
  {
    paqueteNombre: 'Escapada Cancún 3 Noches',
    fechaSalida: '2026-07-06',
    fechaRegreso: '2026-07-09',
    cupoMaximo: 30,
    cupoMinimo: 5,
    cupoDisponible: 28,
  },
  ...
  {
    paqueteNombre: 'Acapulco Clásico 2 Noches',
    fechaSalida: '2026-07-17',
    fechaRegreso: '2026-07-19',
    cupoMaximo: 20,
    cupoMinimo: 3,
    cupoDisponible: 0,
  },
  ...
  {
    paqueteNombre: 'Mazatlán Familiar 4 Noches',
    fechaSalida: '2026-07-31',
    fechaRegreso: '2026-08-04',
    cupoMaximo: 30,
    cupoMinimo: 5,
    cupoDisponible: 25,
  },
  ...
  {
    paqueteNombre: 'Escapada Cancún 3 Noches',
    fechaSalida: '2026-09-04',
    fechaRegreso: '2026-09-07',
    cupoMaximo: 30,
    cupoMinimo: 5,
    cupoDisponible: 18,
  },
...
export async function runSeed(): Promise<void> {
  const { seedUbicaciones } = await import('../ubicaciones/seed-ubicaciones.js');
  ...
  const mexico = await paisRepo.findOne({ where: { codigoIso2: 'MX' } });
  ...
  for (const data of DESTINOS_SEED) {
    ...
    if (!destino) {
      destino = await destinoRepo.save(
        destinoRepo.create({
          ...data,
          paisId: mexico?.id ?? null,
        }),
      );
  ...
  const SERVICIOS_SEED: Array<{
    ...
    {
      nombre: 'Vuelo redondo',
      tipo: TipoServicio.VUELO,
      categoria: CategoriaServicio.TRANSPORTE,
      icono: '✈️',
    },
    {
      nombre: 'Transporte en Van',
      tipo: TipoServicio.TRANSPORTE_VAN,
      categoria: CategoriaServicio.TRANSPORTE,
      icono: '🚐',
    },
    {
      nombre: 'Transporte en Autobús',
      tipo: TipoServicio.TRANSPORTE_AUTOBUS,
      categoria: CategoriaServicio.TRANSPORTE,
      icono: '🚌',
    },
    {
      nombre: 'Transporte Marítimo',
      tipo: TipoServicio.TRANSPORTE_MARITIMO,
      categoria: CategoriaServicio.TRANSPORTE,
      icono: '⛴️',
    },
    {
      nombre: 'Transporte Aéreo',
      tipo: TipoServicio.TRANSPORTE_AEREO,
      categoria: CategoriaServicio.TRANSPORTE,
      icono: '🛩️',
    },
    {
      nombre: 'Todo Incluido',
      tipo: TipoServicio.TODO_INCLUIDO,
      categoria: CategoriaServicio.ALIMENTACION,
      icono: '🍽️',
    },
    {
      nombre: 'Solo Almuerzo',
      tipo: TipoServicio.SOLO_ALUERZO,
      categoria: CategoriaServicio.ALIMENTACION,
      icono: '🥗',
    },
    {
      nombre: 'Media Pensión',
      tipo: TipoServicio.MEDIA_PENSION,
      categoria: CategoriaServicio.ALIMENTACION,
      icono: '🌅',
    },
    {
      nombre: 'Solo Desayuno',
      tipo: TipoServicio.SOLO_DESAYUNO,
      categoria: CategoriaServicio.ALIMENTACION,
      icono: '☕',
    },
    {
      nombre: 'Paquetes al Mar',
      tipo: TipoServicio.PAQUETE_MAR,
      categoria: CategoriaServicio.GENERAL,
      icono: '🌊',
    },
    {
      nombre: 'Excursiones',
      tipo: TipoServicio.EXCURSION,
      categoria: CategoriaServicio.GENERAL,
      icono: '🏔️',
    },
    {
      nombre: 'Crucero',
      tipo: TipoServicio.CRUCERO,
      categoria: CategoriaServicio.GENERAL,
      icono: '🚢',
    },
    {
      nombre: 'Bodas y XV',
      tipo: TipoServicio.BODA_XV,
      categoria: CategoriaServicio.GENERAL,
      icono: '💒',
    },
  ];
  ...
  for (const data of PAQUETES_SEED) {
    const exists = await paqueteRepo.findOne({
      where: { nombre: data.nombre },
    });
    if (exists) continue;
    ...
    if (!destino) {
      console.log(
        `Seed: Destino "${data.destinoNombre}" no encontrado para paquete "${data.nombre}", saltando`,
      );
      continue;
    }

    await paqueteRepo.save(
      paqueteRepo.create({
        nombre: data.nombre,
  ...
  for (const data of FECHAS_SALIDA_SEED) {
    ...
    if (!paquete) {
      console.log(
        `Seed: Paquete "${data.paqueteNombre}" no encontrado para fecha, saltando`,
      );
      continue;
    }
    ...
    const exists = await fechaRepo.findOne({
      where: {
        ...
        fechaSalida: new Date(data.fechaSalida) as any,
      },
    });
    if (exists) continue;
    ...
    console.log(
      `Seed: Fecha "${data.fechaSalida}" - "${data.paqueteNombre}" creada`,
    );
  }
